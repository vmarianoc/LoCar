    ...
    <body>
        ...
        <div data-layer="c29ea42a-d886-4086-a597-e008cc1158b0" class="web1920Cadastro justify-content-center">
            ...
            <div data-layer="2d856e97-239d-461b-b200-d47678f5e26d">
                ...
                pattern="[a-zA-Záãâéêíîóôõú\s]+$" maxlength="50" required>
            </div>
            ...
            <div data-layer="d1f460b1-a9ca-4286-9a8d-71418be2cce4">
                ...
                placeholder="Digite um endereço de e-mail válido" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"
            ...
            <div data-layer="38f644ef-7e4d-4b8e-84a8-60ee1dd9b19b">
                <input class="cepDado" type="text" placeholder="XXXXX-XXX" name="cep"  id="cep" pattern="[0-9]+$" maxlength="9" 
            ...
            <div data-layer="fc5d65e1-fd0c-4dcd-a50b-b2033e5fd3d2" >
                ...
                pattern="[a-zA-Záãâéêíîóôõú\s]+$" maxlength="50" id="bairro"></div>
            ...
            <div data-layer="6251f79e-9646-44ef-b226-630b5ede6196">
                <input class="opcional" type="text" placeholder="Opcional" name="complemento" pattern="[a-zA-Záãâéêíîóôõú\s]+$" 
